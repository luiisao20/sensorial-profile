    ...
    <div class="relative p-4 w-full max-w-md max-h-full md:mx-auto translate-y-1/2">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <div v-if="showSubmit">
                    <button @click="emit('sendData')" type="button" :disabled="isLoading" :class="`text-white bg-${modalType} focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center`">
                        <div v-if="isLoading">
                    ...
                    <button @click="emit('closeModal')" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                        No, cancelar
                    </button>
                </div>
                <div v-else>
